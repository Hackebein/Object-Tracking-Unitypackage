...
namespace Hackebein.ObjectTracking
{
    public class Setup : MonoBehaviour
    {
        ...
        public string[] modesText = { "Simple", "Advanced" };
        ...
        private AnimatorController CreateBoolParameterAndAddToAnimator(AnimatorController controller, string name,
            bool value = false)
        {
        ...
        private AnimatorController CreateFloatParameterAndAddToAnimator(AnimatorController controller, string name,
            float value = 0.0f)
        {
        ...
        private AnimatorController CreateIntParameterAndAddToAnimator(AnimatorController controller, string name,
            int value = 0)
        {
        ...
        private VRCExpressionParameters.Parameter CreateIntExpressionParameter(string name, int value = 0,
            bool saved = true, bool synced = true)
        {
        ...
        private VRCExpressionParameters CreateIntParameterAndAddToExpressionParameters(
            VRCExpressionParameters expression, string name, int value = 0, bool saved = true, bool synced = true)
        {
        ...
        private VRCExpressionParameters.Parameter CreateFloatExpressionParameter(string name, float value = 0.0f,
            bool saved = true, bool synced = true)
        {
            VRCExpressionParameters.Parameter parameter = new VRCExpressionParameters.Parameter();
            parameter.name = name;
        ...
        private VRCExpressionParameters CreateFloatParameterAndAddToExpressionParameters(
            VRCExpressionParameters expression, string name, float value = 0.0f, bool saved = true, bool synced = true)
        {
        ...
        private VRCExpressionParameters.Parameter CreateBoolExpressionParameter(string name, bool value = false,
            bool saved = true, bool synced = true)
        {
            VRCExpressionParameters.Parameter parameter = new VRCExpressionParameters.Parameter();
            parameter.name = name;
        ...
        private VRCExpressionParameters CreateBoolParameterAndAddToExpressionParameters(
            VRCExpressionParameters expression, string name, bool value = false, bool saved = true, bool synced = true)
        {
        ...
        private AnimatorStateTransition CreateBoolTransition(string name, string variable, bool value,
        ...
        private AnimatorTransition CreateEntryBoolTransition(string name, string variable, bool value,
            AnimatorState target)
        {
            AnimatorCondition condition0 = new AnimatorCondition();
            condition0.parameter = variable;
        ...
        private void Remove(string name, GameObject root, AnimatorController controller,
        ...
        private void Create(string name, GameObject root, AnimatorController controller,
            VRCExpressionParameters expressionParameters, Dictionary<string, int[]> axes, float scale)
        {
            // Layer Design:
            //   x:   30, y: 190
            //   x: +240, y: +80
            ...
            foreach (KeyValuePair<string, int[]> axe in axes)
            {
                ...
                for (int i = 0; i < accuracyBytes; i++)
                {
                    ...
                    motions.Add("ObjectTracking/" + name + "/" + axe.Key + "-Byte" + i + "-Float",
                        CreateClip(name + "/" + axe.Key + "-Byte" + i, "", "ObjectTracking/" + name + "/" + axe.Key,
                ...
                for (int i = 0; i < accuracyBits; i++)
                {
                    ...
                    motions.Add("ObjectTracking/" + name + "/" + axe.Key + "-Bit" + i + "-Float",
                        CreateClip(name + "/" + axe.Key + "-Bit" + i, "", "ObjectTracking/" + name + "/" + axe.Key,
                            multiplicator, multiplicator));
                    offset += 1;
                }
            }
        ...
        private static void AddSubAssetsToDatabase(AnimatorControllerLayer animatorControllerLayer,
    ...
    public class ObjectTrackingEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            setup.mode = (Setup.Modes)GUILayout.Toolbar(setup.mode.GetHashCode(), setup.modesText);
            ...
            // TODO: dropdown for avatar selection? or better filter for current solution
            // TODO: preselect Avatar if there is only one in scene
            ...
            if ((Setup.Modes.Expert & setup.mode) != 0)
            {
                EditorGUILayout.BeginHorizontal();
            ...
            if (((Setup.Modes.Advanced | Setup.Modes.Expert) & setup.mode) != 0)
            {
                EditorGUILayout.BeginHorizontal();
            ...
            {
                ((Setup)target).ValidateAndCreate();
            }
            ...
            {
                ((Setup)target).ValidateAndRemove();
            }
            ...
            {
                ((Setup)target).ValidateAndRemoveAll();
            }
